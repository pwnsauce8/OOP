...
/************************************************************
 * Testovací třída {@code VytvareniOsobyTest} slouží ke komplexnímu
 *  otestování třídy ...
 *
 * @author    Pavel Herout
 * @version   3.00.000
 */
public class VytvareniOsobyTest {
...
//###########################################################
  ...
  public void setUp() {
        ...
        prekryvVlasu = new Obdelnik(0, 35, 90, 70, Platno.getPlatno().getBarvaPozadi());
